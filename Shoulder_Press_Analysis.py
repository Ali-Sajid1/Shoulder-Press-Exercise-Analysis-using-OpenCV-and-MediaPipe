...
def play_video():
    ...
    back_btn = Button(video, text = '< Back', bg = "red", fg = "Black", font = "Times 14 bold", relief = "groove", borderwidth = 5, command=back_browse)
    back_btn.place(x = 50, y = 30, width=100, height=30)
...
can.create_text(480, 30, text="WELCOME", font="Times 30 bold", fill="red")

can.create_text(450, 90, text="\"CV Based Shoulder Press Exercise Analysis\"", font="Times 22 bold", fill="red")

can.create_text(110, 220, text="Designed By:", font="Times 20 underline", fill="red")

can.create_text(130, 300, text="Ali Sajid         2020-MC-64 \n\nNoor Sultan  2020-MC-46", font="Times 15 bold italic", fill="red")

can.create_text(420, 220, text="Instructor:", font="Times 21 underline", fill="red")

can.create_text(390, 300, text="Mr. Ahsan Naeem", font="Times 15 bold italic", fill="red")
...
about_button = Button(win, text='About Us', bg='black', fg='red', font='Times 13 bold', borderwidth = 10, relief="groove", command = about)
